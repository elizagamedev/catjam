label frankie_date_1:
    pc neutral "Nothing in particular. Are you free tonight?"
    ...
    show frankie smug at center with dissolve
    ...
    frankie happy "Let's get right into it. You're here because you wanna learn from the best, am I right?"
    ...
    frankie talking "Alright, we're wasting time yapping we could be spending doing pushups. Show me what you've got."
    ...
    pc neutral "What's that?"

    frankie smug "Like a bolt of lightning from Olympus. Think about it, jack."
    frankie "A day's twenty-four hours, and that's that--it's a fact about as fixed as gravity."
    frankie talking "But with the right magic, your perception of time could change. One hour can stretch to three."
    ...
    menu(screen="dialog_choice"):
        "That sounds dangerous..." ("concern"):
            ...
            "Frankie narrows their eyes at me."
    ...
    frankie happy "You really impressed me today, jack. I'll share a slice of the pie with you. You're a perfect fit for my assistant."
    frankie "Look into the elemental binding for me this week, will you? We can have another shindig sometime to talk progress."
    frankie neutral "And don't slack off on those gains, either. I don't want some scrawny twig on the byline of my paper."

    "Frankie starts to head back towards town before pausing."

    frankie smug "What do you say to another round of burgers before we head home?"
